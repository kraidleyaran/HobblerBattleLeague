...
{
    [CreateAssetMenu(fileName = "On Percent Health Trait", menuName = "Ancible Tools/Traits/Combat/On Event/On Percent Health")]
    public class OnPercentHealthTrait : Trait
    {
        ...
        {
            var description = $"On {_percent:F} % Health, ";
